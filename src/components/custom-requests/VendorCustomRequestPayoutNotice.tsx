...
import {
  getVendorCustomRequestPayoutNotice,
...
export function VendorCustomRequestPayoutNotice({
  request,
  variant = "full",
}: Props) {
  const notice = getVendorCustomRequestPayoutNotice(request);
    ...
    >
      <div className="flex gap-3">
        ...
        <div className="min-w-0 flex-1">
          ...
          {request.dispute?.reason && !isCompact && (
