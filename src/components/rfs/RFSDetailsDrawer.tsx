      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className={`fixed ${isMobile ? 'bottom-0 left-4 right-4 h-[85vh] max-h-[85vh] rounded-t-3xl' : 'top-0 right-0 bottom-0 w-[90%] max-w-[600px] rounded-l-2xl'} bg-white shadow-2xl z-[1000] flex flex-col overflow-hidden`}
          >
            {/* Header */}
