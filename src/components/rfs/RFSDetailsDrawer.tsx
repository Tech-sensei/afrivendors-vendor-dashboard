      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className={`fixed ${isMobile ? 'bottom-0 left-0 right-0 h-[85vh] max-h-[85vh] rounded-t-[24px]' : 'top-0 right-0 bottom-0 w-[90%] max-w-[600px] rounded-l-2xl'} bg-white shadow-2xl z-[1000] flex flex-col overflow-hidden`}
          >
            {/* Header */}
            ...
            {/* Footer Actions */}
            <div className="p-6 border-t border-accent-10/50 bg-secondary-800">
              {isNew && (
