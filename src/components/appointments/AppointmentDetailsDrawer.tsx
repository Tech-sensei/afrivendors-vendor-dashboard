      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className={`fixed ${isMobile ? 'bottom-0 left-0 right-0 h-[90vh] rounded-t-3xl' : 'top-0 right-0 bottom-0 w-[480px] rounded-l-2xl'} bg-white shadow-2xl z-[1000] flex flex-col overflow-hidden`}
          >
            {/* Header */}
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-8">
             ...
             {/* Footer Actions */}
             <div className="p-6 border-t border-accent-10/50 bg-white space-y-3">
                {isPending && (
                  <>
                    <button
                      onClick={onAccept}
